...
export function* makePaymentItem(payload) {
  const { accountId, paidByMemberId, paidToMemberId, amount, remarks, createdAt } = payload;
  ...
  const responseData = yield call(
    axios.post,
    `${VITE_SERVICE_HOST}/accounts/makePayment`,
    {
      accountId,
      paidByMemberId,
      paidToMemberId,
